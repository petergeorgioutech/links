  ...
  <div>
    <div class="container px-0 main-wrapper">
      ...
      <div class="container d-flex flex-column min-vh-70">
        <div class="row avi">
          <div class="col">
            <div class="text-center avatar rounded-circle"><div class="rounded-circle" :style="profileImage"></div>
            </div>
          </div>
        </div>
        ...
        <div class="row content-wrapper">
          <div class="col-10 offset-1 links">
            <nuxt-link to="/promotions" class="link">
              <span class="link-image" :style="couponImage" style="background-size:70%;background-position:center center;"></span>
          ...
          <div class="col-10 offset-1 links">
            <nuxt-link to="/partners" class="link">
              <span class="link-image" :style="partnersImage" style="background-size:contain;background-position:center center;"></span>
    ...
    <b-modal id="modal-1" title="Coming Soon ✨" hide-footer>
      <div class="row">
        <div class="col-12">
          ...
          <h3 class="title text-center mb-3 h4 mt-3">Sign up below to be the first to know when the E-Book is released! </h3>
        </div>
        <div class="col-12">
          <!-- Begin Mailchimp Signup Form -->
          <link href="//cdn-images.mailchimp.com/embedcode/classic-071822.css" rel="stylesheet" type="text/css">
          <div id="mc_embed_signup">
              <form action="https://tech.us21.list-manage.com/subscribe/post?u=cef0d5f27e1a3959c4d32cea8&amp;id=caa488f38c&amp;f_id=0070c1e1f0" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
          ...
          <div class="mc-field-group">
            ...
            <div id="mce-responses" class="clear foot">
              ...
              <div style="position: absolute; left: -5000px;" aria-hidden="true"><input type="text" name="b_cef0d5f27e1a3959c4d32cea8_caa488f38c" tabindex="-1" value=""></div>
                  <div class="optionalParent">
                      <div class="clear foot">
                          <input type="submit" value="Subscribe" name="subscribe" id="mc-embedded-subscribe" class="button">
                          <p class="brandingLogo"><a href="http://eepurl.com/icGc9z" title="Mailchimp - email marketing made easy and fun"><img src="https://eep.io/mc-cdn-images/template_images/branding_logo_text_dark_dtp.svg"></a></p>
                      </div>
                  </div>
              </div>
          </form>
